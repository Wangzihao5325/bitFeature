  ...
  render() {
    return (
      <View style={{ height: 50, width: DEVICE_WIDTH, display: 'flex', flexDirection: 'row', backgroundColor: NORMAL_BACKGROUNDCOLOR, borderTopColor: 'black', borderTopWidth: 1 }}>
        ...
        <Item iconName='flash' title='快捷' onPress={function () { console.log('1') }} />
        <Item iconName='bell-o' title='提醒' onPress={function () { console.log('1') }} />
        <Item iconName='heart-o' title='自选' onPress={function () { console.log('1') }} />
      </View>
    );
  }
}