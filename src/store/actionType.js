...
export const TRADE_FLASH_LOGIN_WITH_NAVI_SHOW = 'TRADE_FLASH_LOGIN_WITH_NAVI_SHOW';
export const TRADE_FLASH_LOGIN_WITH_NAVI_UNSHOW = 'TRADE_FLASH_LOGIN_WITH_NAVI_UNSHOW';
export const WAITING_MARKET_SOCKET_RESTART = 'WAITING_MARKET_SOCKET_RESTART';
export const WAITING_TRADE_SOCKET_RESTART = 'WAITING_TRADE_SOCKET_RESTART';
export const MARKET_SOCKET_RESTART_DONE = 'MARKET_SOCKET_RESTART_DONE';
export const TRADE_SOCKET_RESTART_DONE = 'TRADE_SOCKET_RESTART_DONE';
...
export const TRADE_DATA_CLEAR = 'TRADE_DATA_CLEAR';
